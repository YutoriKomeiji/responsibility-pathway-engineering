...
| `docs/document-redundancy-review-initial-pass-sync-note.md` | You need the sync state after the first redundancy-review findings pass, including completed groups, restart order, and the rule that the next step is selection rather than automatic consolidation. |
| `docs/document-redundancy-review-follow-up-selection.md` | You need the post-initial-pass selection rule for choosing one low-risk redundancy-review follow-up without starting automatic merge, deletion, rename, or broad rewrites. |
| `docs/document-redundancy-review-task-inventory-connection.md` | You need the focused connection between current task selection and the post-initial-pass document-redundancy route after a broad task-inventory rewrite is unnecessary or unsafe. |
...
| `docs/document-redundancy-review-findings-phase-snapshots.md` | You need the findings note for phase snapshots, sync logs, focused sync notes, restart pointers, and phase-adjacent roadmap notes, including current state versus synchronization history. |
| `docs/document-redundancy-review-findings-roadmap-deferred.md` | You need the findings note for roadmap notes, deferred-work notes, current task surfaces, restart-condition notes, and phase-adjacent planning documents, including broad roadmap direction versus active task selection versus deferred gates. |
| `docs/document-redundancy-review-findings-public-publication.md` | You need the findings note for public-entry documents, publication-readiness notes, Zenn reader-path notes, walkthrough planning, cadence notes, and public-facing scope candidates, including public entry versus publication approval versus external review boundaries. |
| `docs/document-redundancy-review-findings-standardization-external-review.md` | You need the findings note for standardization-preparation notes, external-review readiness notes, external-review package notes, public-adoption notes, progress notes, and related public-facing maturity boundaries, including preparation versus certification, endorsement, conformance, or finished-standard claims. |
