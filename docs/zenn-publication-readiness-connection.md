# Zenn Publication Readiness Connection
...
Primary connected document:

- `docs/zenn-publication-readiness-plan.md`

Related public-entry and review documents:
...
This note keeps the Zenn publication plan reachable while preserving the distinction between:
...
Disallowed near-term framing:

- finished standard
- conformance-ready system
- certification-ready system
- production-ready system
- implemented connector suite
