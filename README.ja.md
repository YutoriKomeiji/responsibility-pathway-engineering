...
Phase 3 の入口境界は [docs/reference-implementation-boundary.md](docs/reference-implementation-boundary.md) にあります。Reference implementation を追加する前に読む文書です。
...
9. [docs/reference-implementation-boundary.md](docs/reference-implementation-boundary.md) - Phase 3 reference implementation の前に読む境界文書
10. [docs/phase-1-6-plan.md](docs/phase-1-6-plan.md) - 軽量検証とライフサイクル例の現在地
11. [formal/lean/README.md](formal/lean/README.md) - Lean形式化の境界と現在の invariant candidates
12. [docs/phase-2-current-snapshot.md](docs/phase-2-current-snapshot.md) - Phase 2 Lean の現在地と再開点
13. [docs/phase-2-lean-split-plan.md](docs/phase-2-lean-split-plan.md) - Phase 2 Lean split plan と non-goals
14. [docs/phase-2-lean-theorem-index.md](docs/phase-2-lean-theorem-index.md) - Phase 2 Lean theorem role index
15. [docs/definition.md](docs/definition.md) - 中核定義
16. [docs/eight-elements.md](docs/eight-elements.md) - 8要素モデル
17. [docs/repository-governance.md](docs/repository-governance.md) - リポジトリ運営方針
18. [docs/development-process.md](docs/development-process.md) - 開発プロセス
19. [docs/schema-cross-reference.md](docs/schema-cross-reference.md) - schema間の対応関係
20. [spec/review-result.schema.yaml](spec/review-result.schema.yaml) - 境界付き確認結果の出力 schema
21. [docs/validation-checklist.md](docs/validation-checklist.md) - 境界付き検証チェックリスト
22. [docs/validator-boundary.md](docs/validator-boundary.md) - 軽量検証ツールの境界
23. [docs/checker-coverage.md](docs/checker-coverage.md) - 現在のライフサイクル対応チェッカー範囲
24. [docs/example-index.md](docs/example-index.md) - 例の索引と読み方
25. [docs/example-review-notes.md](docs/example-review-notes.md) - 例に対する初期レビュー記録
